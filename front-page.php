	...
	<div class="container mx-auto p-4 md:p-8">
		<div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
			...
			$features = [
				...
				['icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'title' => 'Unlock Property Value', 'link' => get_permalink(get_page_by_path('services'))],
				['icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4', 'title' => 'Effortless Management', 'link' => get_permalink(get_page_by_path('services'))],
				['icon' => 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z', 'title' => 'Smart Investments', 'link' => get_permalink(get_page_by_path('services'))],
			];
			foreach ($features as $f): ?>
			<a href="<?php echo $f['link']; ?>" class="bg-estatein-dark-800 border border-estatein-dark-700 rounded-xl p-8 flex flex-col items-center text-center group hover:border-estatein-purple/50 transition-all duration-300">
